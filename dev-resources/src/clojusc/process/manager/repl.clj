(ns clojusc.process.manager.repl
  ...
  (:require
    ...
    [clojusc.process.manager.components.core :as core]
    [clojusc.process.manager.components.docker :as docker]
    [clojusc.process.manager.components.process :as process]
...
(def setup-options {
  :init 'clojusc.process.manager.components.core/init
  :after-refresh 'clojusc.process.manager.dev/init-and-startup
  :throw-errors false})
...
(defn init
  ...
  (logger/set-level! '[clojusc.process.manager] :debug)
